...
// initializing PitchPrint (use my own API key and design ID)    
    var ppClient = new PitchPrintClient({
        apiKey: 'key_26edfc2cb57d64ce529a3a9e098c63bd',
        designId: 'dcat_2edefcc64e533f8e25c438362e275744',
        custom: true
    });
...
// This function will run/launch the app once it's ready for use 
    ...
    var projectSaved = (_val) => {
        ...
        if (_data && _data.previews && _data.previews.length) {
            _previewDiv.innerHTML = _data.previews.reduce((_str, prev) => `${_str}<img src="${_prev}" />`, ''); 
        }
    }
